...
### Changes
- fix: document cross-repo Pub/Sub schema dependencies (#3505) (#3580)

**Source:** project-beta-api@88676cd9
...
### Changes
- feat: enhance media API with video support, CDN URLs, bulk ops, and storage tracking (#3577)

**Source:** project-beta-api@12d82bc6
...
### Changes
- feat: add data export API with CSV/JSON formats and async job support (#3571)

**Source:** project-beta-api@59c150fa
...
### Changes
- feat: add content approval workflow API with multi-stage pipeline (#3558)

**Source:** project-beta-api@49a39158
...
### Changes
- feat: add webhook event system with test events, rate limiting, and delivery tracking (#3554)

**Source:** project-beta-api@ea90f864
...
### Changes
- feat: add search and filtering for campaigns and posts (#3547)

**Source:** project-beta-api@38c2f67a
...
### Changes
- feat: add content editing and version history endpoints (#3540)

**Source:** project-beta-api@b491bd6e
...
### Changes
- feat: add notification preferences and PATCH mark-as-read endpoint (#3538)

**Source:** project-beta-api@90d384fb
...
### Changes
- feat: add webhook dispatch for campaign lifecycle events (#3535)

**Source:** project-beta-api@0189d06f
...
### Changes
- feat: add cross-brand comparison endpoint for side-by-side crawl data (#3533)

**Source:** project-beta-api@beb5e0a2
...
### Changes
- feat: add brand data enrichment validation for content generation (#3527)

**Source:** project-beta-api@e1557d55
...
### Changes
- feat: improve campaign lifecycle management for staging readiness (#3520)

**Source:** project-beta-api@23b12769
...
### Changes
- feat: add granular rate limits for public auth endpoints (#3515)

**Source:** project-beta-api@1e3a70e7
...
### Changes
- fix: token refresh reliability — proactive refresh and structured logging (#3510)

**Source:** project-beta-api@b417e719
...
### Changes
- fix: align all API specs with actual implementation (#3503)

**Source:** project-beta-api@364a2d28
...
### Changes
- fix: return structured error codes on token refresh failure (#3478)

**Source:** project-beta-api@bde9f3e1

## [v0.7.1317] - 2026-03-15

### Changes
- feat: add publish failure notifications for scheduled posts (#3477)

**Source:** project-beta-api@179cfa7a
...
### Changes
- fix: handle missing brand_model_config table gracefully in get_model_config (#3473)

**Source:** project-beta-api@c3c4bdb7
...
### Changes
- fix: merge migration heads to unblock alembic upgrade (#3470)

**Source:** project-beta-api@b0aaddb3
...
### Changes
- fix: set variant_index default to 0 to fix placeholder post creation (#3464)

**Source:** project-beta-api@90446804
...
### Changes
- feat: add structured logging to content generation pipeline (#3447)

**Source:** project-beta-api@1dd12d75
...
### Changes
- fix: use INTEGER for campaign_learning_state FK to match campaigns.id type (#3443)

**Source:** project-beta-api@6be817e7

## [v0.7.1285] - 2026-03-14

### Changes
- fix: merge two concurrent migration head merges into single chain (#3442)

**Source:** project-beta-api@aa9631ba
...
### Changes
- fix: repair migration chain — fix 3 broken down_revision refs and merge 19 heads (#3440)

**Source:** project-beta-api@6970bcae

## [v0.7.1282] - 2026-03-14

### Changes
- fix: repair migration chain and add missing crawlstatus enum value (#3439)

**Source:** project-beta-api@15fc58a6
...
### Changes
- feat: add campaign scheduling and content calendar endpoints (#3416)

**Source:** project-beta-api@655238c7

## [v0.7.1266] - 2026-03-12

### Changes
- feat: add content generation pipeline webhook event types (#3414)

**Source:** project-beta-api@7b23e8c7
...
### Changes
- test: add integration tests for new content pipeline endpoints (#3402)

**Source:** project-beta-api@afde8e9a
...
### Changes
- feat: add Instagram Insights integration (#3394)

**Source:** project-beta-api@296b4e1b
...
### Changes
- feat: re-implement notification system (#3385)

**Source:** project-beta-api@e29d10e0

## [v0.7.1237] - 2026-03-11

### Changes
- feat: add multi-user brand access with membership and roles (#2614) (#3384)

**Source:** project-beta-api@358e9aba

## [v0.7.1236] - 2026-03-11

### Changes
- perf: speed up test suite by reducing per-test overhead (#2687) (#3383)

**Source:** project-beta-api@00f49ee6
...
### Changes
- feat: add structured audit logging middleware for API operations (#3377)

**Source:** project-beta-api@05b8457a
...
### Changes
- feat: add engagement data ingestion pipeline with webhook and scheduler endpoints (#2995) (#3372)

**Source:** project-beta-api@0434912a
...
### Changes
- test: add comprehensive integration tests for content generation pipeline (#3365)

**Source:** project-beta-api@2d7b768e

## [v0.7.1219] - 2026-03-11

### Changes
- feat: add i18n support for API error messages (#3006) (#3363)

**Source:** project-beta-api@6a927d49
...
### Changes
- fix: replace incorrect MIT license with proprietary license (#3349)

**Source:** project-beta-api@2af562d8
...
### Changes
- feat: persist ML monitoring baselines in database (#3075) (#3344)

**Source:** project-beta-api@9ba14aa6

## [v0.7.1201] - 2026-03-11

### Changes
- feat: add load and performance testing infrastructure (#3074) (#3345)

**Source:** project-beta-api@09186877
...
### Changes
- feat: add flaky test detection and quarantine system (#3076) (#3342)

**Source:** project-beta-api@69719a18

## [v0.7.1198] - 2026-03-11

### Changes
- feat: add integration health monitoring endpoint (#3341)

**Source:** project-beta-api@5d16adbb

## [v0.7.1197] - 2026-03-11

### Changes
- feat: add content performance tracking and engagement feedback loop (#3067) (#3339)

**Source:** project-beta-api@7b557ce1
...
### Changes
- fix: encrypt OAuth tokens at rest with Fernet symmetric encryption (#3065) (#3331)

**Source:** project-beta-api@d5aa6738
...
### Changes
- fix: resolve test failures in content outputs controller and generation cost repository (#3328)

**Source:** project-beta-api@f5931ff9

## [v0.7.1185] - 2026-03-09

### Changes
- fix: add missing GenerationCostService mock and fix brands seed INSERT (#3327)

**Source:** project-beta-api@0b808072

## [v0.7.1184] - 2026-03-09

### Changes
- fix: bind GenerationCostService mock and fix brands seed INSERT in tests (#3325)

**Source:** project-beta-api@c60575ec

## [v0.7.1183] - 2026-03-09

### Changes
- fix: bind GenerationCostService mock and fix brands seed INSERT in tests (#3324)

**Source:** project-beta-api@13cb9097
...
### Changes
- fix: return 404 instead of 500 for non-existent campaign export (#3281) (#3282)

**Source:** project-beta-api@f5c34474
...
### Changes
- deps(deps-dev): Bump pytest-env from 1.1.0 to 1.5.0 (#3245)

**Source:** project-beta-api@53a7c6a9
...
### Changes
- deps(deps-dev): Bump ruff from 0.7.0 to 0.15.2 (#3246)

**Source:** project-beta-api@c62f77ed
...
### Changes
- fix: add PATCH /api/v2/users/me endpoint for profile updates (#3237) (#3238)

**Source:** project-beta-api@31c02db7

## [v0.7.1147] - 2026-02-19

### Changes
- fix: resolve 401 on DELETE /sessions logout endpoint (#3235) (#3236)

**Source:** project-beta-api@f99e979d
...
### Changes
- feat: add GDPR cascade soft-delete service for user data (#3134)

**Source:** project-beta-api@c11392e8
...
### Changes
- fix: add PUT /users/me endpoint for profile editing (#3205) (#3208)

**Source:** project-beta-api@e0a011ef
...
### Changes
- fix: add POST /auth/reset-password compat endpoint (#3207) (#3212)

**Source:** project-beta-api@e6e0ae46
...
### Changes
- fix: Prevent direct status bypass on PUT /brands/{id} (#3184) (#3190)

**Source:** project-beta-api@8947d461
...
### Changes
- fix: add GET endpoint for campaign performance metrics (#3192) (#3193)

**Source:** project-beta-api@06b6d503
...
### Changes
- feat: add summary counts to QualityGateResult response (#2567) (#3047)

**Source:** project-beta-api@bba4b218
...
### Changes
- refactor: consolidate ownership checks and user_id extraction (#2926, #2927) (#2964)

**Source:** project-beta-api@9a501af8
...
### Changes
- fix: add Redis idempotency for Pub/Sub content completion tracking (#2898) (#2992)

**Source:** project-beta-api@306ad5cf
...
### Changes
- chore: regenerate stale openapi.json (#2955)

**Source:** project-beta-api@f2cabf3c
...
### Changes
- fix: publish brand crawl synchronously instead of BackgroundTask (#2896) (#2922)

**Source:** project-beta-api@53b0df06
...
### Changes
- deps(deps-dev): Bump ruff from 0.7.0 to 0.15.1 (#2874)

**Source:** project-beta-api@ea789449
...
### Changes
- refactor: replace custom LRU cache with cachetools.LRUCache (#2834)

**Source:** project-beta-api@96290723
...
### Changes
- fix(gate-13): fall back to brand.crawl_data for products, key_phrases, and audience (#2801)

**Source:** project-beta-api@1d4ef17f
...
### Changes
- fix(bug-001): race condition where posts not created before Content Designer runs (#2796)

**Source:** project-beta-api@91de0948

## [v0.7.971] - 2026-02-05

### Changes
- fix(gate-10): use non-empty brand_id for Post Generator fan-out (#2795)

**Source:** project-beta-api@b2f7cb2f
...
### Changes
- fix(gate-10): include experience_prompt in PostSchema response (#2790)

**Source:** project-beta-api@58ce60f9
...
### Changes
- fix(db): Correct add_experience_prompt to depend on fix_mediastatus_enum (#2783)

**Source:** project-beta-api@25974318
...
### Changes
- feat(gate-10): Add experience_prompt field to Posts model and schemas (#2779)

**Source:** project-beta-api@b78a0949
...
### Changes
- docs(specs): add checkmark format for implementation tracking (#2770)

**Source:** project-beta-api@56cae638
...
### Changes
- docs(specs): simplify logging specs - remove overengineering (#2768)

**Source:** project-beta-api@0e4a6021

## [v0.7.943] - 2026-02-03

### Changes
- docs(specs): add logging requirements for troubleshooting (#2767)

**Source:** project-beta-api@6388e5f4
